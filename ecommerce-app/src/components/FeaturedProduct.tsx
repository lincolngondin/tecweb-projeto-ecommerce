          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 aspect-square flex items-center justify-center">
                <div className="text-6xl"><img src="https://goodluckafrica.com/wp-content/uploads/2024/02/Galaxy-24-ultra.webp" alt="" /></div>
              </div>
            </div>
            
            <div className="space-y-6">
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">SAMSUNG A15 5G</h2>
                <div className="space-y-2 text-gray-300">
                  <p><span className="text-gray-400">Preço:</span> 1200.00 R$</p>
